...
class LeadEditorAgent(Agent):
    def __init__(self) -> None:
        super().__init__(
            ...
            "\n"
            "\n### play_specific_motion ツールの使用（最優先）"
            "\n**ユーザーが具体的な動作や感情表現を要求した場合は、必ずこのツールを使用してください**"
            "\n"
            "\n主要なモーション："
            "\n- **照れる**: haru_g_m01 または haru_g_m20"
            "\n- **驚く**: haru_g_m02 または haru_g_m18"
            "\n- **頷く・同意**: haru_g_m03"
            "\n- **首を振る・否定**: haru_g_m04"
            "\n- **喜ぶ**: haru_g_m06 または haru_g_m19"
            "\n- **落ち込む・悲しむ**: haru_g_m07 または haru_g_m21"
            "\n- **怒る**: haru_g_m08"
            "\n- **笑う**: haru_g_m09"
            "\n- **手を振る・挨拶**: haru_g_m10"
            "\n- **バイバイ**: haru_g_m11"
            "\n- **お辞儀**: haru_g_m12"
            "\n- **指差す**: haru_g_m13"
            "\n- **疑問・首をかしげる**: haru_g_m14"
            "\n- **ウィンク**: haru_g_m22"
            "\n- **拍手**: haru_g_m24"
            "\n"
            "\n使用例："
            "\n- ユーザー「照れて」→ play_specific_motion('haru_g_m01')"
            "\n- ユーザー「手を振って」→ play_specific_motion('haru_g_m10')"
            "\n- ユーザー「笑って」→ play_specific_motion('haru_g_m09')"
            "\n- ユーザー「頷いて」→ play_specific_motion('haru_g_m03')"
            "\n"
            ...
            "\n- **悲しい・困った場面**: 'F05' (悲しい)"
            "\n"
            "\n**重要**: ユーザーが直接「照れて」「手を振って」「笑って」などの指示をした場合は、"
            "\n**必ず play_specific_motion ツールを使用**してください。"

...
export function ChatInput({ onSend, className, disabled, ...props }: ChatInputProps) {
  ...
  return (
    ...
    >
      <div className="flex-1 flex items-center gap-2 rounded-full bg-white/5 backdrop-blur-xl border border-white/20 px-5 py-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.1)]">
        <input
          autoFocus
          ref={inputRef}
          type="text"
